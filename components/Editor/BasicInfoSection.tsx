...
export const BasicInfoSection: React.FC = () => {
  ...
  return (
    <Space orientation="vertical" style={{ width: '100%' }} size="large">
      {/* Title */}
      <div>
        <Form.Item label={t.title} style={{ marginBottom: '8px' }}>
          <Input
      ...
      {/* Description */}
      <div>
        <Form.Item label={t.description} style={{ marginBottom: '8px' }}>
          <TextArea
      ...
      {/* Timestamp */}
      <Form.Item label={t.addTimestamp}>
        <Switch
